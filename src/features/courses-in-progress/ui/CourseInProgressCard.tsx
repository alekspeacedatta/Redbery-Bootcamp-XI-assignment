...
export const CourseInProgressCard = ( { enrolledCourse } : CourseInProgressCardType ) => {
  return (
    <div key={enrolledCourse.id} className='
    ...
    '>
        ...
        <div className='flex gap-4'>
            {/* Course Image */}
            <img src={enrolledCourse.course.image} alt="Course Image" className='rounded-xl h-30.75' />
        ...
        <div className='flex gap-10 justify-between items-center'>
            <div className='flex flex-col gap-1 w-full'>
                ...
                <div className='w-full h-3.75 bg-[#DDDBFA] rounded-[30px]'>
                    <div className={`w-[${String(enrolledCourse.progress)}%] bg-[#4F46E5] rounded-[30px] h-3.75`}>
                    </div>
                </div>
            </div>
