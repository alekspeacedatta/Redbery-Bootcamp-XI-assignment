    ...
    ">
      <div className="flex flex-col gap-4.5 h-full justify-between">
          <div className="flex flex-col gap-4.5 items-start">
              {/* Image */}
              <img src={course.image} alt="Course Image" className="rounded-[10px] h-45.5 object-cover w-full" />
          ...
          <div className="flex justify-between courses-center">
              ...
              <div className="flex flex-col gap-0.5">
                ...
                {/* Details Button */}
              <Button variant="primary" className='py-3 px-6.25 leading-6 font-medium'>
                  Details
              </Button>
          </div>
      </div>
