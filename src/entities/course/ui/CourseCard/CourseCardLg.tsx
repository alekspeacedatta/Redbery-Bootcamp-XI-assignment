    ...
    ">
      <div className="flex flex-col justify-between h-full gap-6">
          <div className="flex flex-col gap-4">
              {/* Image */}
              <img src={course.image} alt="Course Image" className="rounded-[10px] h-65.5 object-cover" />
              ...
              <div className="flex flex-col gap-3">
                  ...
                  <div className="flex justify-between">
                      <p className="text-sm text-[#8A8A8A] font-medium leading-none">
                          Lecture 
                          <span className="text-[#666666]"> {course.instructor.name}</span>
                      </p>
          ...
          <div className="flex justify-between items-center">
              ...
              <div className="flex items-center gap-2">
                ...
                {/* Details Button */}
              <Button variant="primary" className='h-12 px-6.25 text-xl leading-none font-medium'>
                  Details
              </Button>
          </div>
      </div>
